...
/// <returns></returns>
__global__ void findArea(const float2* thphi, const float2* thphi_disk, const int M, const int N, float* area, float max_accretion_radius, const unsigned char* diskMask, float3* incident_dirs) {
